...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/openmobilemaps/maps-core.git", .upToNextMinor(from: "3.0.0")),
        .package(url: "https://github.com/openmobilemaps/layer-gps.git", .upToNextMinor(from: "3.0.0"))
    ],
    targets: [
        .target(
            name: "SwisstopoMapSDK",
