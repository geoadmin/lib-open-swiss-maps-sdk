...
CJNIEXPORT ::djinni_generated::NativeTiled2dMapRasterLayerInterface::JniType JNICALL Java_ch_admin_geo_openswissmaps_shared_layers_SwisstopoLayerFactory_createSwisstopoTiledRasterLayer(JNIEnv* jniEnv, jobject /*this*/, ::djinni_generated::NativeSwisstopoLayerType::JniType j_layerType, jobject j_tileLoaders)
{
    try {
...
CJNIEXPORT ::djinni_generated::NativeTiled2dMapRasterLayerInterface::JniType JNICALL Java_ch_admin_geo_openswissmaps_shared_layers_SwisstopoLayerFactory_createSwisstopoTiledRasterLayerFromMetadata(JNIEnv* jniEnv, jobject /*this*/, ::djinni_generated::NativeWmtsLayerDescription::JniType j_description, jint j_maxZoom, ::djinni_generated::NativeTiled2dMapZoomInfo::JniType j_zoomInfo, jobject j_tileLoaders)
{
    try {
